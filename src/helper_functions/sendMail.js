...
var gridKey = process.env.GRID_KEY;
mail_1["default"].setApiKey(gridKey);
var sendConfirmationEmail = function (email) { return __awaiter(void 0, void 0, void 0, function () {
    var required_otp, e_1;
