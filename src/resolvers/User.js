...
var User = {
    posts: function (parent, args, ctx, info) { return __awaiter(void 0, void 0, void 0, function () {
        var posts, e_1, posts, e_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!(args.visibility === "ALL")) return [3 /*break*/, 4];
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, Post_1["default"].find({ developer: args._id })];
                case 2:
                    posts = _a.sent();
    ...
    comments: function (parent, args, ctx, info) { return __awaiter(void 0, void 0, void 0, function () {
        var postExists, e_3, comments, e_4;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, Post_1["default"].findById(args.idOfPost)];
                case 1:
                    postExists = _a.sent();
                    if (!postExists) {
